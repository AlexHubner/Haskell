...
instance Print AbsLI.Program where
  prt i e = case e of
    AbsLI.Prog classdeclarations -> prPrec i 0 (concatD [prt 0 classdeclarations])

instance Print AbsLI.ClassDeclaration where
  prt i e = case e of
    AbsLI.ClassD id memberdeclarations -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id, doc (showString "{"), prt 0 memberdeclarations, doc (showString "}")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]

instance Print AbsLI.MemberDeclaration where
  prt i e = case e of
    AbsLI.Attr decl -> prPrec i 0 (concatD [prt 0 decl, doc (showString ";")])
    AbsLI.Mth type_ id decls stms -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 decls, doc (showString ")"), doc (showString "{"), prt 0 stms, doc (showString "}")])
  prtList _ [] = concatD []
  prtList _ (x:xs) = concatD [prt 0 x, prt 0 xs]
...
instance Print AbsLI.Stm where
  prt i e = case e of
    ...
    AbsLI.SExp exp -> prPrec i 0 (concatD [prt 0 exp, doc (showString ";")])
...
instance Print AbsLI.Exp where
  prt i e = case e of
    ...
    AbsLI.EMthCall id1 id2 exps -> prPrec i 6 (concatD [prt 0 id1, doc (showString "."), prt 0 id2, doc (showString "("), prt 0 exps, doc (showString ")")])
    AbsLI.ENew id -> prPrec i 7 (concatD [doc (showString "new"), prt 0 id, doc (showString "()")])
    AbsLI.EInt n -> prPrec i 8 (concatD [prt 0 n])
    AbsLI.EVar id -> prPrec i 8 (concatD [prt 0 id])
    AbsLI.EStr str -> prPrec i 8 (concatD [prt 0 str])
    AbsLI.ETrue -> prPrec i 8 (concatD [doc (showString "true")])
    AbsLI.EFalse -> prPrec i 8 (concatD [doc (showString "false")])
  prtList _ [] = concatD []
  prtList _ [x] = concatD [prt 0 x]
  prtList _ (x:xs) = concatD [prt 0 x, doc (showString ","), prt 0 xs]
...
instance Print AbsLI.Type where
  prt i e = case e of
    ...
    AbsLI.TClass id -> prPrec i 0 (concatD [prt 0 id])
